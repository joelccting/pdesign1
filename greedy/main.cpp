...
//﻿﻿﻿由最前面取出第一個工作，工作取出後表示這個工作送入機器執行，可以執行的工作數增加 1。
﻿﻿﻿//所有剩餘的工作中，若開始時間早於正在執行工作的結束時間，就放棄執行這些工作，直到找到開始時間等於或晚於正在執行工作的結束時間，將找到的工作放入機器執行，可以執行的工作數增加1。
﻿﻿﻿//繼續將所有剩餘的工作中，若開始時間早於正在執行工作的結束時間，就放棄執行這些工作，直到找到開始時間等於或晚於正在執行工作的結束時間，將找到的工作放入機器執行，可以執行的工作數增加1。
